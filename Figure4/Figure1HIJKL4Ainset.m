...
plot(D,times/60,'-k','LineWidth',3)
hold on
xline(100,'--','color',[0 0.4470 0.7410],'LineWidth',3)
xline(138.8,'--','color',[0.8500 0.3250 0.0980],'LineWidth',3)
xline(157.5,'--','color',[0.9290 0.6940 0.1250],'LineWidth',3)
xline(175,'--','color',[0.4940 0.1840 0.5560],'LineWidth',3)
